...
extension UIColor {
    ...
    public class func RGBA (_ r:CGFloat,_ g:CGFloat,_ b:CGFloat,_ a:CGFloat = 1) -> UIColor{
    ...
    /// - Returns: UIColor
    @objc public class func color_HexStr(_ colorStr:String?) -> UIColor {
        return self.color_HexStr(colorStr, alpha: 1)
    }
    @objc public class func color_HexStr(_ colorStr:String?, alpha: CGFloat = 1) -> UIColor {
